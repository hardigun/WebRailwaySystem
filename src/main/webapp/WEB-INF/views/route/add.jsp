...
<form:form id="routeEntityForm" modelAttribute="routeEntity" method="POST" action="/route/add">
    <fieldset>
        ...
        <table>
            ...
            <tr>
                <td colspan="3">
                    <span id="routeStationsErrors" class="message-error"
                        <c:if test="${empty routeStationsErrors}">
                            style="display: none;"
                        </c:if>
                            ><c:out value="${routeStationsErrors}" default=""/></span>
                </td>
            </tr>
                            ...
                            <tr id="station_${stationIndex.index}">
                                ...
                                <td>
                                    <input type="text" id="timeoffset_${stationIndex.index}" name="timeoffsets[]"
                                           value="${station.timeOffset}" class="timeoffset-spinner-input"/>
                                </td>
                                <td>
            ...
            <tr>
                <td colspan="3"><input type="button" id="submitButton" value="Ok" /></td>
            </tr>
        </table>
    </fieldset>
</form:form>
